...
typedef __xu_typeref__(cookies);

/*! the cookies instances
 *
 * @return          the cookies
 */
xu_cookies_ref_t xu_cookies(xu_noarg_t);

/*! init cookies
 *
 * @return          the cookies
 */
xu_cookies_ref_t xu_cookies_init(xu_noarg_t);

/*! exit cookies
 *
 * @param cookies   the cookies
 */
xu_void_t xu_cookies_exit(xu_cookies_ref_t cookies);
 ...
 */
xu_bool_t xu_cookies_set(xu_cookies_ref_t cookies, xu_char_t const* domain, xu_char_t const* path, xu_bool_t secure,
 ...
 * @return          xu_true or xu_false
 */
xu_bool_t xu_cookies_set_from_url(xu_cookies_ref_t cookies, xu_char_t const* url, xu_char_t const* value);
 ...
 */
xu_char_t const* xu_cookies_get(xu_cookies_ref_t cookies, xu_char_t const* domain, xu_char_t const* path,
                                xu_bool_t secure, xu_string_ref_t value);
 ...
 * @return          the cookies data
 */
xu_char_t const* xu_cookies_get_from_url(xu_cookies_ref_t cookies, xu_char_t const* url, xu_string_ref_t value);

/*! clear cookies
 *
 * @param cookies   the cookies
 */
xu_void_t xu_cookies_clear(xu_cookies_ref_t cookies);
 ...
 * @param cookies   the cookies
 */
xu_void_t xu_cookies_dump(xu_cookies_ref_t cookies);
#endif
