 ...
 * trace
 */
#define XU_TRACE_MODULE_NAME "bloom_filter_open"
...
xu_int_t xm_bloom_filter_open(lua_State* lua)
{
    ...
    xu_bloom_filter_ref_t filter = xu_bloom_filter_init(probability, hash_count, item_maxn, xu_element_str(xu_true));
    if (filter)
